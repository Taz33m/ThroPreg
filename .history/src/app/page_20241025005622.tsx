    ...
    <div className="min-h-screen bg-gradient-to-b from-[#FFF5E6] to-[#FFE4E1]">
      ...
      <main className="pt-16">
        ...
        <div ref={contentRef} className="container mx-auto px-4 py-16 space-y-16">
          ...
          <section id="thyroid-info" className="container mx-auto px-4 py-16 space-y-8">
            <h2 className="text-4xl font-semibold text-center text-[#4A0E0E]">Thyroid Information</h2>
            ...
            <div className="text-center mt-8">
              <Link 
                ...
                className="inline-flex items-center text-[#8B0000] hover:text-[#4A0E0E] transition-colors"
              >
