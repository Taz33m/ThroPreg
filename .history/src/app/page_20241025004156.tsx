          ...
          <section id="expert-insights" className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="bg-[#FFF5E6] border-[#8B0000] shadow-lg">
                <CardHeader>
                  <CardTitle className="text-2xl text-[#4A0E0E]">Audio: Case Study by Dr. John Doe</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <p className="text-[#4A0E0E] text-lg">
                      Listen to Dr. John Doe present a case study on managing thyroid disorders during pregnancy, 
